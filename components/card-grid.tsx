...
export default function CardGrid() {
  ...
  const selectedDest = selectedDestId !== null 
        ...
        {currentDestination ? (
          <Card className="md:col-span-3 sm:col-span-2 bg-[1D0C2E]/30 p-6 rounded-lg border-2 text-white">
            <CardHeader className="flex justify-between">
              <h3 className="text-2xl md:text-4xl font-bold font-lemon tracking-widest">{currentDestination.univ}</h3>
              <Image
            ...
            <CardContent className="grid gap-6">
              <div className="md:flex grid justify-between gap-6 text-sm md:text-base">
                ...
                />
                <p className="text-base md:text-xl font-montserrat">{currentDestination.location}</p>
              </div>
