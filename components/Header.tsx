  ...
  return (
    <div className='py-2 flex mb-6'>
        ...
        <div className='ml-4 flex flex-col justify-center '>
            ...
            <p className='text-xl font-semibold font-montserrat bg-gradient-to-r from-[var(--background-gradient1)] via-[#DC6EC2] to-[var(--background-gradient1)] bg-clip-text text-transparent'>UniTour</p>
        </div>
    </div>
  )
}
